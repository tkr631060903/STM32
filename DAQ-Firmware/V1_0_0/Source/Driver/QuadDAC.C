...
int I2C1_ByteWrite(u8 devAddr, u8 pBuffer, u8 WriteAddr)
{
    ...
    while(!I2C_CheckEvent(I2C1, I2C_EVENT_MASTER_MODE_SELECT) && index <1000000)
    {
        index ++;
    }
    ...
    while(!I2C_CheckEvent(I2C1, I2C_EVENT_MASTER_TRANSMITTER_MODE_SELECTED) && index <2000000)
    {
        index ++;
    }
...
void I2C1_BufferWrite(u8 devAddr, u8* buffer, u8 WriteAddr, int numToWrite)
{
    u8* pBuffer = buffer;
    /* Send STRAT condition */
    I2C_GenerateSTART(I2C1, ENABLE);
...
//    void I2C1_BufferWrite(u8 devAddr, u8* buffer, u16 WriteAddr, int numToWrite)
    ...
    I2C1_BufferWrite(0xC0,buffer+1,buffer[0],2);
