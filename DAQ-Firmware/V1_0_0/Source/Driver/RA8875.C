...
void Init_RA875(void)
{
	...
	WriteCommand(0x88);	//SYS_CLK = FIN*(PLLDIVN[4:0] +1)/((PLLDIVM+1)*(2^PLLDIVK[2:0]))=16*10/16=10
	WriteData(0x14);	//PLLDIVN[4:0] = 20   PLLDIVM =0
...
void LCD_Reset(void)
{
	GPIOD->BRR  = GPIO_Pin_13; //RA8875 RESET pin
	DelayMs(110);
