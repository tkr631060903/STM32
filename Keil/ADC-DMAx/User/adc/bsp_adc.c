...
static void ADCx_GPIO_Config(void)
{
    ...
    GPIO_InitStruct.GPIO_Pin = ADC_PIN3;
    GPIO_InitStruct.GPIO_Pin = ADC_PIN4;
    GPIO_InitStruct.GPIO_Pin = ADC_PIN5;
    GPIO_InitStruct.GPIO_Pin = ADC_PIN6;
...
static void ADCx_Mode_Config(void)
{
    ...
    ADC_RegularChannelConfig(ADC_x_Init, ADC_Channel1, 1, ADC_SampleTime_55Cycles5);
    ADC_RegularChannelConfig(ADC_x_Init, ADC_Channel2, 2, ADC_SampleTime_55Cycles5);
    ADC_RegularChannelConfig(ADC_x_Init, ADC_Channel3, 3, ADC_SampleTime_55Cycles5);
    ADC_RegularChannelConfig(ADC_x_Init, ADC_Channel4, 4, ADC_SampleTime_55Cycles5);
    ADC_RegularChannelConfig(ADC_x_Init, ADC_Channel5, 5, ADC_SampleTime_55Cycles5);
    ADC_RegularChannelConfig(ADC_x_Init, ADC_Channel6, 6, ADC_SampleTime_55Cycles5);
