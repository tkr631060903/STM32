...
static void ADC_GPIO_Config(void)
{
    ...
    GPIO_InitStructure.GPIO_Pin  = ADCx_1_CHANNEL_1_PIN;
    GPIO_InitStructure.GPIO_Mode = GPIO_Mode_AIN;
    GPIO_Init(ADCx_1_CHANNEL_1_PORT, &GPIO_InitStructure);
    GPIO_InitStructure.GPIO_Pin  = ADCx_1_CHANNEL_2_PIN;
    GPIO_InitStructure.GPIO_Mode = GPIO_Mode_AIN;
    GPIO_Init(ADCx_1_CHANNEL_2_PORT, &GPIO_InitStructure);


    // ADCx_2 GPIO 初始化
    ADCx_2_APBxClock_FUN(ADCx_2_CLK, ENABLE);
    GPIO_InitStructure.GPIO_Pin  = ADCx_2_CHANNEL_1_PIN;
    GPIO_InitStructure.GPIO_Mode = GPIO_Mode_AIN;
    GPIO_Init(ADCx_2_CHANNEL_1_PORT, &GPIO_InitStructure);
    GPIO_InitStructure.GPIO_Pin  = ADCx_2_CHANNEL_2_PIN;
    GPIO_InitStructure.GPIO_Mode = GPIO_Mode_AIN;
    GPIO_Init(ADCx_2_CHANNEL_2_PORT, &GPIO_InitStructure);
}
